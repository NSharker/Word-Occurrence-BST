  ...
  class BinarySearchTree : public BinaryTreeInterface<ItemType, OtherType>
{
 ...
 BinarySearchTree(): root_(nullptr) { };
  ...
  //Find the word specified by the user
  //Visit is a client function
  //anItem is the item we are searching for
  void findWord(void visit(ItemType&,OtherType&), const ItemType& anItem)const throw(NotFoundException);
  ...
  //------------------------------------------------------------
  // Overloaded Public Traversals Section.
  //------------------------------------------------------------
  void PreorderTraverse(void visit(ItemType&,OtherType&)) const;
  void InorderTraverse(void visit(ItemType&,OtherType&)) const;
  void PostorderTraverse(void visit(ItemType&,OtherType&)) const;
 ...
 private:
  ...
  // Overloaded Recursive traversal helper methods:
  void Preorder(void visit(ItemType&,OtherType&), BinaryNode<ItemType, OtherType>* node_ptr) const;
  void Inorder(void visit(ItemType&,OtherType&), BinaryNode<ItemType, OtherType>* node_ptr) const;
  void Postorder(void visit(ItemType&,OtherType&), BinaryNode<ItemType, OtherType>* node_ptr) const;
